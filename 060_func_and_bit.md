...
<div align="center">
<img src="images/060_fig_1.png" width="50%">
<p>1 bit 左シフト</p>
</div>

<div align="center">
<img src="images/060_fig_2.png" width="50%">
<p>1 bit 右シフト</p>
</div>
---
...
* これに `1` を足すと、箱には8個しか入らないので、はみ出した分は消えて表示は **`0` (0b00000000)** に戻ってしまいます。
...
    if val >= 32768:
        val = val - 65536  # 2の補数の逆算
    
    # 3. 128 で割って温度(℃)にする（センサーの仕様書ルール）
    temp = val / 128.0
    return temp
